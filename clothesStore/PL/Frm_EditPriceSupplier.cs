...
{
    public partial class Frm_EditPriceSupplier : Form
    {
        public Frm_EditPriceSupplier()
        {
            InitializeComponent();
            textBox1.Focus();
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Form2.getmain.dataGridView1.CurrentRow.Cells[2].Value = textBox1.Text;
            ...
            {
                MessageBox.Show("يرجى تحديد السعر");
            }
        }
